...
public class CommonRdbmsWriter {
    ...
    public static class Job {
        ...
        public void writerPreCheck(Configuration originalConfig,
        ...
        public void prePostSqlValid(Configuration originalConfig,
            DataBaseType dataBaseType) {
            /* 检查PreSql跟PostSql语句 */
        ...
        public void privilegeValid(Configuration originalConfig,
            DataBaseType dataBaseType) {
            /* 检查insert 跟delete权限 */
            String username = originalConfig.getString(Key.USERNAME);
            String password = originalConfig.getString(Key.PASSWORD);
            List<Object> connections = originalConfig.getList(
                Constant.CONN_MARK, Object.class);

            for (int i = 0, len = connections.size(); i < len; i++) {
                Configuration connConf = Configuration.from(connections.get(i)
                    .toString());
                String jdbcUrl = connConf.getString(Key.JDBC_URL);
                List<String> expandedTables = connConf.getList(Key.TABLE,
                    String.class);
    ...
    public static class Task {
        ...
        public void init(Configuration writerSliceConfig) {
            ...
            if (this.jdbcUrl.startsWith(Constant.OB10_SPLIT_STRING)
                ...
                String[] ss = this.jdbcUrl
                    .split(Constant.OB10_SPLIT_STRING_PATTERN);
                if (ss.length != 3) {
                ...
                this.jdbcUrl = ss[2];
                LOG.info("this is ob1_0 jdbc url. user=" + this.username
                    + " :url=" + this.jdbcUrl);
            }
            ...
            this.batchByteSize = writerSliceConfig.getInt(Key.BATCH_BYTE_SIZE,
                Constant.DEFAULT_BATCH_BYTE_SIZE);
        ...
        public void prepare(Configuration writerSliceConfig) {
            ...
            int tableNumber = writerSliceConfig
                .getInt(Constant.TABLE_NUMBER_MARK);
            if (tableNumber != 1) {
                LOG.info("Begin to execute preSqls:[{}]. context info:{}.",
        ...
        protected PreparedStatement fillPreparedStatementColumnType(
            ...
            switch (columnSqltype) {
                ...
                case Types.DOUBLE:
                    ...
                    if (column.getType() == Type.BOOL) {
                        strValue = column.asLong().toString();
                    } else {
                ...
                case Types.DATE:
                    if (this.resultSetMetaData.getRight().get(columnIndex)
                        ...
                        if (column.asBigInteger() == null) {
                            ...
                            preparedStatement.setInt(columnIndex + 1, column
                                .asBigInteger().intValue());
                        }
                    } else {
                        ...
                        .asDataXException(
                            ...
                            String
                                .format(
                                    ...
                                    this.resultSetMetaData.getLeft().get(
                                        columnIndex),
                                    this.resultSetMetaData.getMiddle().get(
                                        columnIndex),
                                    this.resultSetMetaData.getRight().get(
                                        columnIndex)));
            }
            return preparedStatement;
        }
        ...
        private void calcWriteRecordSql() {
            if (!VALUE_HOLDER.equals(calcValueHolder(""))) {
                ...
                INSERT_OR_REPLACE_TEMPLATE = WriterUtil.getWriteTemplate(
                    columns, valueHolders, writeMode, dataBaseType,
                    forceUseUpdate);
                writeRecordSql = String.format(INSERT_OR_REPLACE_TEMPLATE,
                    this.table);
            }
        }

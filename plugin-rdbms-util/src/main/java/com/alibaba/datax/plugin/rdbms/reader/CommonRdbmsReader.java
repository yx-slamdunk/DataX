...
public class CommonRdbmsReader {
    ...
    public static class Job {
        ...
        public void preCheck(Configuration originalConfig,
            ...
            Configuration queryConf = ReaderSplitUtil
                .doPreCheckSplit(originalConfig);
            String splitPK = queryConf.getString(Key.SPLIT_PK);
            List<Object> connList = queryConf.getList(Constant.CONN_MARK,
                Object.class);
            ...
            for (int i = 0, len = connList.size(); i < len; i++) {
                Configuration connConf = Configuration.from(connList.get(i)
                    .toString());
                PreCheckTask t = new PreCheckTask(username, password, connConf,
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            this.mandatoryEncoding = readerSliceConfig.getString(
                Key.MANDATORY_ENCODING, "");
        ...
        public void startRead(Configuration readerSliceConfig,
            ...
            PerfTrace.getInstance().addTaskDetails(taskId,
                table + "," + basicMsg);

            LOG.info("Begin to read record by Sql: [{}\n] {}.", querySql,
                basicMsg);
            PerfRecord queryPerfRecord = new PerfRecord(taskGroupId, taskId,
            ...
            try {
                ...
                PerfRecord allResultPerfRecord = new PerfRecord(taskGroupId,
                    taskId, PerfRecord.PHASE.RESULT_NEXT_ALL);
                ...
                while (rs.next()) {
                    ...
                    this.transportOneRecord(recordSender, rs, metaData,
                        columnNumber, mandatoryEncoding, taskPluginCollector);
                ...
                e.printStackTrace();
                throw RdbmsException.asQueryException(this.dataBaseType, e,
                    querySql, table, username);
            } finally {
        ...
        protected Record transportOneRecord(RecordSender recordSender,
            ...
            String mandatoryEncoding, TaskPluginCollector taskPluginCollector) {
                ...
                for (int i = 1; i <= columnNumber; i++) {
                    switch (metaData.getColumnType(i)) {
                        ...
                        case Types.TIMESTAMP:
                            record
                                .addColumn(new DateColumn(rs.getTimestamp(i)));
                            break;
